...
case 
    ...
    items."u_argns_pl" as Production_Lifecycle,
...
items."sheight1" as HEIGHT,
items."slength1" as LENGTH,
items."svolume" as VOLUME,
items."sweight1" as WEIGHT,
items."swidth1" as WIDTH,
